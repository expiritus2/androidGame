...
public class HighscoreButtons {
    ...
    public HighscoreButtons(GameMain game) {
        ...
        createAmdPositionUIElements();
        stage.addActor(backBtn);
        stage.addActor(scoreLabel);
        stage.addActor(coinLabel);
    }

    void createAmdPositionUIElements(){
        ...
        backBtn.setPosition(17, 17, Align.bottomRight);


        scoreLabel.setPosition(GameInfo.WIDTH / 2f - 40, GameInfo.HEIGHT / 2f - 115);
