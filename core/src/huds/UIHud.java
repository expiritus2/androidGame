...
public class UIHud {
    ...
    public void createGameOverPanel(){
        Image gameOverPanel =
                new Image(new Texture("Buttons/Pause/Show Score.png"));
        ...
        BitmapFont forn = generator.generateFont(parameter);

        Label endScore = new Label(String.valueOf(GameManager.getInstance().score),
                new Label.LabelStyle(forn, Color.WHITE));
        ...
        endCoinScore.setPosition(GameInfo.WIDTH / 2f,
